class Work < ActiveRecord::Base
  ...
  def self.to_csv
    attributes = %w{id brand_name campaign_title agency track_name artist_name description vimeo platform image_url fb_image_url slide_image_url slideshow slide_title}
